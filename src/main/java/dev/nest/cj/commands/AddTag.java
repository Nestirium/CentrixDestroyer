...
public class AddTag extends ListenerAdapter {
        ...
        if (content.startsWith(".addtag")) {
            ...
            switch (args.length) {
                ...
                case 3:
                    ...
                    StatementHandler.addTag(user, tag);
                    message.getChannel().sendMessage("Chat tag has been added successfully... ✅").queue();
                    break;
                default:
