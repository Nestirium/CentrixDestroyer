...
public class SetTag extends ListenerAdapter {
        ...
        if (content.startsWith(".settag")) {
            ...
            switch (args.length) {
                ...
                case 3:
                    ...
                    StatementHandler.setTag(user, tag);
                    message.getChannel().sendMessage("Chat tag has been set successfully... ✅").queue();
                    break;
                default:
