...
public class ClearTags extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(@NotNull GuildMessageReceivedEvent event) {
        ...
        if (content.startsWith(".cleartags")) {
            ...
            switch (args.length) {
                ...
                case 2:
                    ...
                    StatementHandler.removeCurrentTag(user);
                    StatementHandler.clearTags(user);
                    message.getChannel().sendMessage("All tags for this user are now cleared! ✅").queue();
                    break;
                default:
