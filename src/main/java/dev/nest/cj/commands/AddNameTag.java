...
public class AddNameTag extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(@NotNull GuildMessageReceivedEvent event) {
        ...
        if (content.startsWith(".addnametag")) {
            ...
            switch (args.length) {
                ...
                case 3:
                    ...
                    StatementHandler.addNameTag(user, tag);
                    message.getChannel().sendMessage("Name tag has been added successfully... ✅").queue();
                    break;
                default:
